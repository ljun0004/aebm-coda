...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, f_BChw: torch.Tensor, accelerator, ret_usages=False) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor, List[float]]:
        f_BChw = f_BChw.float()
        ...
        # update vocab_usage
        prob_per_class_is_chosen = accelerator.reduce(prob_per_class_is_chosen, reduction="sum")
