...
LOAD_PATH="${PROJECT_ROOT}/ckpts/vq-f8-n256/mar_large/masked_coda_qknorm0_swiglu0_rope1_rmsnorm0_woshift0/checkpoint-last.pth"
SAVE_PATH="${PROJECT_ROOT}/ckpts/vq-f8-n256/mar_large/masked_coda_qknorm0_swiglu0_rope1_rmsnorm0_woshift0"
